...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-xl border border-white/10 bg-[#141a24]/85 p-1 text-muted-foreground backdrop-blur-sm",
      className
    )}
    {...props}
  />
